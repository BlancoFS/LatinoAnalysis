...
class rochester_corr(TreeCloner):
    ...
    def process(self,**kwargs):
        ...
        for bname, bvariable in list(self.oldBranchesToBeModifiedSimpleVariable.items()): self.otree.Branch(bname,bvariable,bname+'/F') 
        ...
        for bname, bvector in list(self.newBranchesToBeAddedVector.items()): self.otree.Branch(bname,bvector)
