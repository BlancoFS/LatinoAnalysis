...
class rochester_corr(TreeCloner):
    ...
    def addOptions(self, parser):
        ...
        group.add_option('-d', '--data', dest='isdata',
                         help='is data or not', default='0')
    ...
    def checkOptions(self, opts):
        ...
        try:
            ROOT.gROOT.LoadMacro(
                cmssw_base+'/src/LatinoAnalysis/Gardener/python/variables/RoccoR.cc+g')
        except RuntimeError:
            ROOT.gROOT.LoadMacro(
                cmssw_base+'/src/LatinoAnalysis/Gardener/python/variables/RoccoR.cc++g')
    ...
    def process(self, **kwargs):
        ...
        self.namesNewBranchesToBeAddedVector = [
            'std_vector_lepton_rochesterMCSF', 'std_vector_lepton_rochesterDataSF']
        ...
        self.clone(output, self.namesOldBranchesToBeModifiedVector +
                   self.namesOldBranchesToBeModifiedSimpleVariable+self.namesNewBranchesToBeAddedVector)
        ...
        for bname, bvector in list(self.newBranchesToBeAddedVector.items()):
            self.otree.Branch(bname, bvector)
            ...
            for iLep in range(len(itree.std_vector_lepton_pt)):
                ...
                if abs(flavour) == 13:
                    ...
                    if self.isdata == 1:
                        ...
                        mcSF = rc.kScaleFromGenMC(
                            charge, pt, eta, phi, nl, matchedgenpt, u1)
