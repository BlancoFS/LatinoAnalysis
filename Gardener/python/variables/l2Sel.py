...
class L2SelFiller(TreeCloner):
    ...
    def addOptions(self, parser):
        ...
        group.add_option('-k', '--kind',  dest='kind',
                         help='Kind of lepton identification to be applied [default is loose leptons]',  default='2')
        group.add_option('-c', '--cmssw', dest='cmssw',
                         help='cmssw version (naming convention may change)', default='763', type='string')
        group.add_option('-s', '--selection', dest='selection',
                         help='apply some selections, like pt cuts', default=0)
    ...
    def isLooseLepton(self, ilepton):
        ...
        if self.itree.std_vector_lepton_pt[ilepton] > 0:
            ...
            if self.cmssw == '763':
                ...
                if (
                   ...
                   and
                    ((
                        (abs(
                            self.itree.std_vector_lepton_eta[ilepton]) <= 1.479)
                       ...
                       or
                       (
                        (abs(self.itree.std_vector_lepton_eta[ilepton]) > 1.479 and abs(
                            self.itree.std_vector_lepton_eta[ilepton]) < 2.5)
                        and (abs(self.itree.std_vector_electron_dEtaIn[ilepton]) < 0.01 and
            ...
            # temp fix for Rereco so it doesn't crash on 74X variables
            ...
            if self.cmssw == '763':
                if (self.itree.std_vector_lepton_isMediumMuon[ilepton] == 1
                        ...
                        # formerly std_vector_lepton_BestTrackdxy
                        and abs(self.itree.std_vector_lepton_d0[ilepton]) < dxy
                        # formerly std_vector_lepton_BestTrackdz
                            and abs(self.itree.std_vector_lepton_dz[ilepton]) < 0.1
            ...
            if self.cmssw == '763':
                ...
                if abs(self.itree.std_vector_lepton_flavour[ilepton]) == 11 and abs(self.itree.std_vector_lepton_eta[ilepton]) < 2.5:
                    ...
                    if (abs(self.itree.std_vector_lepton_flavour[ilepton]) == 11):
                        print(("but what? It should never happen, electrons with eta>2.5 ",
                              self.itree.std_vector_lepton_flavour[ilepton]))
                ...
                if (
                   abs(self.itree.std_vector_lepton_flavour[ilepton]) == 11
                   and abs(self.itree.std_vector_lepton_eta[ilepton]) < 2.5
                   # Needs to be updated to std_vector_lepton_trackIso03
                   and self.itree.std_vector_lepton_trackIso[ilepton]/self.itree.std_vector_lepton_pt[ilepton] < 0.08
                   and
                   ((
                    (abs(self.itree.std_vector_lepton_eta[ilepton]) <= 1.479)
                    and (
                        ...
                        # Needs to be updated
                        abs(self.itree.std_vector_electron_dEtaIn[ilepton]) < 0.00308 and
                        abs(self.itree.std_vector_electron_dPhiIn[ilepton]) < 0.020 and
                    ...
                    and (
                        ...
                        # Needs to be updated
                        abs(self.itree.std_vector_electron_dEtaIn[ilepton]) < 0.00605 and
                ...
                if jlepton != ilepton:
                    if self.itree.std_vector_lepton_pt[jlepton] > 0:
                        if self.isAcloseToB(self.itree.std_vector_lepton_eta[jlepton], self.itree.std_vector_lepton_phi[jlepton],
                                            self.itree.std_vector_lepton_eta[
                                                ilepton], self.itree.std_vector_lepton_phi[ilepton],
                                            isoConSize):
        ...
        if self.itree.std_vector_lepton_pt[ilepton] > 0:
            ...
            if self.cmssw == 'Rereco2016':
                if (abs(self.itree.std_vector_lepton_flavour[ilepton]) == 13
                        and abs(self.itree.std_vector_lepton_eta[ilepton]) < 2.4
                        # formerly std_vector_lepton_BestTrackdxy
                        and abs(self.itree.std_vector_lepton_d0[ilepton]) < 0.5
                        # formerly std_vector_lepton_BestTrackdz
                            and abs(self.itree.std_vector_lepton_dz[ilepton]) < 1.
    ...
    def process(self, **kwargs):
        ...
        vectorsToChange = ['std_vector_lepton_', 'std_vector_electron_',
                           'std_vector_muon_', 'std_vector_jet_', 'std_vector_puppijet_']
        ...
        self.namesNewBranchesVector = ['std_vector_lepton_isLooseLepton',
                                       'std_vector_lepton_isTightLepton', 'std_vector_lepton_isWgsLepton']
        ...
        self.clone(output, self.namesOldBranchesToBeModifiedVector + self.namesOldBranchesToBeModifiedSimpleVariable +
                   self.namesOfSpecialSimpleVariable + self.jetVarList + self.namesNewBranchesVector)
        ...
        try:
            ROOT.gROOT.LoadMacro(
                cmssw_base+'/src/LatinoAnalysis/Gardener/python/variables/WWVar.C+g')
        except RuntimeError:
            ROOT.gROOT.LoadMacro(
                cmssw_base+'/src/LatinoAnalysis/Gardener/python/variables/WWVar.C++g')
            ...
            if goodLep1 >= 0 and goodLep2 >= 0:
                ...
                if len(goodJets) >= 2:
                    ...
                    WW = ROOT.WW(pt1, pt2, eta1, eta2, phi1, phi2, pid1, pid2, met, metphi,
                                 jetpt1, jetpt2, jeteta1, jeteta2, jetphi1, jetphi2, jetmass1, jetmass2)
                else:
                    WW = ROOT.WW(pt1, pt2, eta1, eta2, phi1,
                                 phi2, pid1, pid2, met, metphi)
                ...
                for iGoodLep in goodLeps:
                    new_std_vector_lepton_pt.push_back(
                        itree.std_vector_lepton_pt[iGoodLep])
                    new_std_vector_lepton_eta.push_back(
                        itree.std_vector_lepton_eta[iGoodLep])
                    new_std_vector_lepton_phi.push_back(
                        itree.std_vector_lepton_phi[iGoodLep])
                    new_std_vector_lepton_flavour.push_back(
                        itree.std_vector_lepton_flavour[iGoodLep])

                WW.setLeptons(new_std_vector_lepton_pt, new_std_vector_lepton_eta,
                              new_std_vector_lepton_phi, new_std_vector_lepton_flavour)

                # set the list of jets into the object "WW"
                new_std_vector_jet_pt.clear()
                new_std_vector_jet_eta.clear()
                for iGoodJet in goodJets:
                    new_std_vector_jet_pt.push_back(
                        itree.std_vector_jet_pt[iGoodJet])
                    new_std_vector_jet_eta.push_back(
                        itree.std_vector_jet_eta[iGoodJet])
                ...
                for bname, bvariable in list(self.jetVarDic.items()):
                    bvariable[0] = (
                        getattr(self.otree, 'std_vector_jet_'+self.jetVariables[varCounter]))[counter]
                    counter += 1
                    if counter == maxnjets:
                        varCounter += 1
                        counter = 0
                ...
                if self.cmssw == '763' or self.cmssw == 'ICHEP2016' or self.cmssw == 'Rereco2016' or self.cmssw == 'Full2016':
                    ...
                    for metfilters in range(min(8, len(itree.std_vector_trigger_special))):
                        if itree.std_vector_trigger_special[metfilters] == 0.:
                            pass_met_filters = 0.
                    ...
                    for i1 in range(len(itree.std_vector_lepton_pt)):
                        for i2 in range(i1+1, len(itree.std_vector_lepton_pt)):
                            ...
                            if abs(itree.std_vector_lepton_flavour[i1]) == 13. and itree.std_vector_lepton_flavour[i1] == -1. * itree.std_vector_lepton_flavour[i2]:
                                dmll_temp = abs(math.sqrt(2*itree.std_vector_lepton_pt[i1]*itree.std_vector_lepton_pt[i2]*(math.cosh(
                                    itree.std_vector_lepton_eta[i1]-itree.std_vector_lepton_eta[i2]) - math.cos(itree.std_vector_lepton_phi[i1]-itree.std_vector_lepton_phi[i2]))) - 91.1876)
                                if dmll_temp < dmll:
                                    dmll = dmll_temp
